    ...
    var Za = "IN_PROGRESS"
      ...
      , ts = function(e) {
        ...
        return o(t, [{
            key: "evaluateRow",
            value: function() {
                if (4 === this.tileIndex && !(this.rowIndex >= 6)) {
            ...
            key: "addLetter",
            value: function(e) {
                this.gameStatus === Za && (this.canInput && (this.tileIndex >= 4 || (this.boardState[this.rowIndex] += e,
            ...
            value: function() {
                var e = this.shadowRoot.querySelector("#board-container")
                  , a = Math.min(Math.floor(e.clientHeight * (5 / 6)), 280)
                  , s = 6 * Math.floor(a / 4);
