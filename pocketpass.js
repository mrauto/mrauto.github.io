...
class Store {
  static getItemsArray(jsonArrayName) {
    if (
      ...
      const arr_length = loginArray.length;
      console.info(`PP found ${jsonArrayName}... ${arr_length} labels`);
      loginArray.sort((a, b) =>
        a.label == "undefined" ||
        b.label == "undefined" ||
        a.label.toUpperCase() < b.label.toUpperCase()
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelector("#mySelect").onchange = function() {
    ...
    if (notes == undefined) {
      // format miniArray
      console.info("PP miniArray format... ", label, selectedItem.ct);
    ...
    // document.querySelector("#label").value = document.querySelector("#password").type;
  };
  ...
  // single_password blur
  document.querySelector("#single_password").onblur = () => {
    var passwordjs = document.querySelector("#single_password").value;
    iv0 = document.querySelector("#single_iv").value;
    label = document.querySelector("#single_label").value;
    var rp = {};
    var p = {
      iv: iv0,
      adata: label,
    ...
    p.ct = document.querySelector("#single_ct").value;
    ...
    try {
      ...
      if (error.message.indexOf("ccm") > -1) {
        ...
        document.querySelector("#single_plain").value = "Bad combination";
      }
    }
    if (plaintext.length) {
      document.querySelector("#single_plain").value = plaintext;
  ...
  document.querySelector("#clear").onclick = () => {
    ...
    document.querySelector("#raw").value = "";
    document.querySelector("#single_password").value = "";
    document.querySelector("#single_plain").value = "";
    // refresh select
    document.querySelector("#mySelect").innerHTML = "";
    UI.buildSelect();
    // buttons colors
