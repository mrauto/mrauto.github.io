...
this.wordle.bundle = function(e) {
    ...
    var La = ['defray', 'cutlet', 'purged', 'lacier', 'boasts', 'anyway', 'crafts', 'hooted', 'jester', 'dearly', 'resent', 'squirm', 'usurps', 'winced', 'hearth', 'malady', 'glands', 'hippie', 'loomed', 'verves', 'fooled', 'winked', 'foully', 'pushed', 'breeze', 'lisles', 'bruise', 'clangs', 'irking', 'dakota', 'ocelot', 'damned', 'paddle', 'plaids', 'betels', 'cashes', 'borrow', 'haggis', 'paltry', 'napery', 'gilled', 'embank', 'niches', 'yuccas', 'radons', 'herald', 'ribose', 'nitric', 'pellet', 'purify', 'binges', 'alumna', 'equine', 'subbed', 'rondos', 'mortar', 'pleats', 'weaken', 'across', 'lenses', 'assume', 'writhe', 'buyers', 'hoofed', 'felled', 'vienna', 'fourth', 'marker', 'digger', 'sneers', 'hushes', 'rabies', 'enmity', 'letter', 'orates', 'careen', 'fruits', 'avoids', 'mouths', 'grouse', 'masers', 'impish', 'cliffs', 'fungal', 'vilify', 'shared', 'gasses', 'copula', 'wreath', 'anemia', 'curfew', 'cadmic', 'hinder', 'losses', 'nested', 'howler', 'gasser', 'erased', 'manger', 'phones', 'artful', 'oxbows', 'nurses', 'safety', 'oozing', 'spores', 'chains', 'raised', 'sheets', 'harems', 'tapirs', 'glibly', 'jading', 'folder', 'ardors', 'putsch', 'porous', 'palled', 'fervor', 'mincer', 'conger', 'relish', 'member', 'devout', 'lassos', 'irrupt', 'marlin', 'oddest', 'torpid', 'orbing', 'fiasco', 'frizzy', 'rectos', 'avowed', 'gangly', 'fledge', 'naiads', 'scenes', 'limpid', 'nutria', 'yapped', 'bamboo', 'disarm', 'cystic', 'embank', 'claims', 'pardon', 'miscue', 'affect', 'tiaras', 'lauded', 'francs', 'dreads', 'joggle', 'rogues', 'heeled', 'slangy', 'castes', 'wintry', 'weaned', 'cynics', 'embers', 'cilium', 'smiths', 'fijian', 'earths', 'jounce', 'taught', 'creels', 'solids', 'radian', 'tinges', 'battle', 'cliche', 'rebuke', 'dumber', 'skinks', 'unsnap', 'dandle', 'jammed', 'reaper', 'shower', 'raffia', 'frowns', 'rabbit', 'faster', 'owners', 'taxied', 'leaked', 'ukases', 'tragic', 'ambers', 'scruff', 'safely', 'tartly', 'conger', 'knifed', 'wildly', 'hoagie', 'ovular', 'corded', 'gunmen', 'bezels', 'missal', 'addles', 'rancho', 'bucket', 'panama', 'menace', 'bright', 'flicks', 'combat', 'mourns', 'whited', 'wavers',  'nuclei',  'civics', 'litany',  'family', 'mainly', 'output', 'sender', 'paunch', 'pillow', 'cadres',  'monism', 'rodent', 'priest', 'sigmas', 'tariff', 'podium', 'capita', 'gerund', 'fatale', 'pixels', 'snorts', 'smoggy', 'zygote', 'animal', 'taping', 'bowled', 'macros', 'glazed', 'slacks', 'rigged', 'usages', 'bathes', 'towels', 'strews', 'isomer', 'slalom', 'unwell',  'travel', 'raring', 'richer', 'bacons', 'clucks', 'evened', 'lidded', 'dimmed', 'fibbed', 'resell', 'dishes', 'armlet', 'donors', 'krills', 'tables', 'shrunk',  'truths', 'spares', 'verses', 'flukes', 'uncaps', 'tolled', 'snuffs', 'remedy', 'wizens', 'instep', 'straws', 'peeled', 'scoffs', 'cooing', 'advent', 'dinner', 'twangs', 'shirks', 'crouch', 'bruise', 'medias', 'packed', 'glassy', 'vanish', 'corner', 'warded', 'truant', 'amazon', 'scalar', 'copter', 'worths', 'crater', 'frumpy', 'ripped', 'cruxes', 'slates', 'ragged', 'posers', 'coveys', 'bashes', 'makers', 'hurrah', 'dittos', 'intuit', 'office', 'placer', 'joists', 'hoping', 'luster', 'baling', 'flared', 'blinds', 'minors', 'impose', 'health', 'legume', 'despot', 'verges', 'safety', 'croups', 'recoup', 'clergy', 'weasel', 'slided', 'repeat', 'collie', 'divans', 'hiving', 'remits', 'father', 'abbots', 'mochas', 'spring', 'poplin', 'voyage', 'swatch', 'pariah', 'somber', 'lapper', 'shaken', 'brides', 'dipped', 'heroic', 'chairs', 'archly', 'nature', 'tulips', 'vested', 'dollar', 'ignore', 'jotted', 'skimps', 'became', 'geiger', 'skiing', 'bateau', 'bluest', 'dangle', 'hazard', 'within', 'finers', 'select', 'alkali', 'miscue', 'alders', 'eggnog', 'stands', 'napalm', 'banner', 'septet', 'smirks', 'sprint', 'magnum', 'airmen', 'fluids', 'exited', 'wising', 'vaguer', 'vellum', 'purple', 'bedlam', 'abated', 'creeps', 'grouse', 'yogurt', 'ballet', 'temple', 'podium', 'takers', 'hoaxed', 'doling', 'lignum', 'indian', 'osmium', 'savory', 'tocsin', 'addict', 'spayed', 'jargon', 'savior', 'smooth', 'eyelet', 'pigeon', 'unhurt', 'viewed', 'mislay', 'starry', 'keycap', 'vacate', 'onsets', 'droned', 'bastes', 'rammed', 'hoagie', 'struck', 'depots', 'candle', 'parses', 'docket', 'lamely', 'cetera', 'debate', 'supply', 'nudity', 'hummed', 'dictum', 'solace', 'zapped', 'unborn', 'crewel', 'menthe', 'racist', 'jackal', 'prudes', 'vanish', 'elicit', 'sacked', 'kismet', 'pureed', 'remove',  'gassed', 'zeroed', 'icicle', 'gayety', 'howled', 'trying', 'atomic', 'panted', 'valves', 'jacket', 'humped', 'upturn', 'asides', 'bonier', 'impels', 'trolls', 'robbed', 'felons', 'bitten', 'tartar', 'gauzes', 'errant', 'zinnia', 'burled', 'groans', 'flairs', 'deface', 'bemuse', 'spigot', 'tidies', 'meowed', 'vastly', 'cleave', 'basset', 'goring', 'tilled', 'aghast', 'triton', 'affair', 'vulgar', 'doming', 'fathom', 'homing', 'apogee', 'plunks', 'afraid', 'rhesus', 'addict', 'grimes', 'arabia', 'velvet', 'beater', 'nagger', 'skater', 'bowies', 'deigns', 'rashes', 'dusted', 'rennet', 'booted', 'memoir', 'joiner', 'chases', 'forget', 'answer', 'rating', 'rotate', 'basing', 'taught', 'starts', 'paused', 'snorts', 'sprays', 'gainer', 'assert', 'sludgy', 'shriek', 'sailor', 'cagily', 'homing', 'wooded', 'whites', 'methyl', 'thefts', 'limpid', 'raisin', 'nation', 'celtic', 'induct', 'attack', 'fibber', 'silage', 'lipase', 'choose', 'frisky', 'frozen', 'basset', 'stoker', 'exerts', 'flashy', 'sailor', 'tester', 'ambler', 'flirts', 'arrive', 'dialog', 'bolder', 'mouser', 'czechs', 'feuded', 'brinks', 'revert', 'silver', 'nodule', 'feline', 'dunned', 'antics', 'assort', 'noises', 'hooray', 'sunder', 'saving', 'rashes', 'breton', 'miffed', 'breton', 'smutty', 'sitcom', 'scoots', 'shorts', 'grouch', 'shares', 'quaint', 'pawing', 'bailed', 'blurts', 'cricks', 'derive', 'bleary', 'vialed', 'pleads', 'waylay', 'border', 'ignore', 'floods', 'harped', 'maraca', 'sponge', 'bushes', 'sander', 'oldest', 'unpins', 'enlace', 'lilacs', 'holing', 'sneaks', 'vastly', 'bubble', 'hauled', 'coolie', 'device', 'retire', 'chides', 'shacks', 'arises', 'pastes', 'ruffed', 'dammed', 'vesper', 'viewed', 'sirius', 'cremes', 'mexico', 'jabots', 'minion', 'quebec', 'cupids', 'blazer', 'healer', 'exceed', 'smoked', 'furled', 'sweaty', 'zapped', 'molest', 'bureau', 'deader', 'booted', 'satyrs', 'inured', 'sketch', 'graced', 'vortex', 'dumped', 'hereof', 'tenure', 'retort', 'broach', 'duping', 'dismal', 'flacks', 'obtain', 'wiling', 'floral', 'noggin', 'triune', 'whinny', 'creeks', 'fealty', 'effuse', 'memoir', 'timely', 'druids', 'metric', 'owning', 'paired', 'fairly', 'docile', 'rushes', 'refute', 'spawns', 'stucco', 'bawled', 'golfed']
